                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div className="w-full lg:w-9/12 m-auto flex justify-between mt-24 px-4 flex-wrap">
                            ...
                            <div className="text-left lg:w-full xl:w-2/4  ">
                                ...
                                <div className="mb-2 text-slate-600 mt-5">
                                ...
                                <div className="w-full lg:w-9/12 p-4 border-t border-slate-200">
                                    ...
                                    <div className="flex mb-3 pt-0 w-full justify-between gap-6">
                                        ...
                                        <div className="w-1/4 flex justify-end">
                                            <div className="get-started text-white justify-center w-3/4 flex items-center font-bold rounded outline-none focus:outline-none bg-slate-400 active:bg-slate-500 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150">
                                                Bình luận
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        <p className=" text-md leading-relaxed text-slate-700 font-bold">
                                            User name
                                        </p>
